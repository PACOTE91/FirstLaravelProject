    ...
    <table class="table text-gray-400 border-separate space-y-6 text-sm m-auto">
        <thead class="bg-gray-800 text-gray-500">
            <tr>
                ...
                <th class="p-3 text-center">Descripcion</th>
                ...
                <tr class="bg-gray-800">
                    <td class="p-3">
                        <div class="flex align-items-center">
                            <div class="ml-3">
                                <div class="text-gray-500">{{ $category->id }}</div>
                            </div>
                    ...
                    <td class="p-3 ">
                        <form action="{{ route('categories.destroy', $category) }}" method="POST"
                            ...
                            @method("delete")
                            <button type="submit"
                                onclick="return confirm('Quieres borrar categoría {{ $category->nombre }}')">Eliminar</button>

                        </form>
                        <a href="{{ route('categories.edit', $category) }}" class="text-gray-400 hover:text-gray-100  mx-2">
